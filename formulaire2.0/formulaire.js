                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                Féminin <input type="radio" name="sexe${i + 1}" id="sexe${i + 1}" value="0">
                                Masculin <input type="radio" name="sexe${i + 1}" id="sexe${i + 1}" value="1">
                            </td>
                        <tr>
                            <td>
                                Date de naissance :
                            ...
                            <td>
                                <input type="date" name="dn" id="dateNaissance${i + 1}" onchange="getAgeAdh(${i + 1}), generateCours(${i + 1}), generatePasseport(${i + 1})">
                            </td>
                        </tr>
                        <tr>
                            <td>
...
/*
4.3.  Appendice C : Liste des documents à fournir pour chaque adhérent
➢   CERTIFICAT MEDICAL de moins de 3 ans ou AQS (Attestation questionnaire de santé)
➢   CHEQUE LOCATION JUDOGI (5€), si l’adhérent a choisi d’en louer un.
➢   CHEQUE DE CAUTION JUDOGI (40€), si l’adhérent a choisi d’en louer un.
➢   CHEQUE PASSEPORT (9€) – à partir des mini-poussins sauf si l’adhérent a déjà un passeport. Le
passe port doit être renouvelé lors de l’inscription d’un cadet
➢   PHOTO pour ceux qui commande un passeport.
➢   CHEQUE COTISATION
